    ...
    <form method="POST" action="{{ route('entry_update', $entry->id) }}">
        ...
        <fieldset>
            ...
            <div class="form-group mb-2">
                <label for="quantity" class="form-label mt-4">Quantity of entry</label>
            ...
            <div class="form-group mb-2">
                ...
                <input name="price" type="number" class="form-control" id="price" placeholder="Enter the price"
                    value="{{ $entry->price }}" min="0" required>
            </div>
            <!--Product select -->
            <div class="form-group mb-3">
                <label for="product_id" class="form-label mt-4">Select the product</label>
                <select class="form-select" name="product_id" id="product_id">
                    <option value="{{ $entry->product_id }}" selected>Choose the product</option>
